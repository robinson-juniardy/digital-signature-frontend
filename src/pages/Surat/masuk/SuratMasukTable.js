...
const TABLE_HEAD = [
  { id: 'tanggal_terimasurat', label: 'Tanggal Terima', alignRight: false },
  { id: 'perihal_surat', label: 'Perihal Surat', alignRight: false },
  { id: 'filename', label: 'File', alignRight: false },
  { id: 'jenis_surat', label: 'Jenis Surat', alignRight: false },
  { id: '' },
];
...
const SuratMasukTable = React.memo(({ editProps }) => {
          ...
          <Table>
            ...
            <TableBody>
              {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                const { id, tanggal_terimasurat, perihal_surat, filename, jenis_surat } = row;
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{tanggal_terimasurat.split('T')[0]}</TableCell>
                    <TableCell align="left">{perihal_surat}</TableCell>
                    <TableCell align="left">
                      <a href={`${process.env.REACT_APP_BACKEND}/uploads/${filename}`}>Lihat File</a>
                    </TableCell>
                    <TableCell align="left">{jenis_surat}</TableCell>
                    {/* <TableCell align="left">
                    ...
                    <TableCell align="right">
                      <strong>
                        <Tooltip sx={{ mt: 2 }} title="ubah data">
                          <IconButton color="secondary" onClick={() => editProps(row)}>
                            <EditTwoTone />
                          </IconButton>
                        </Tooltip>
                      </strong>
